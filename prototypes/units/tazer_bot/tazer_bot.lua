local path = util.path("prototypes/units/tazer_bot/")
local name = names.units.tazer_bot

local beam_name = name.."-beam"
local small_beam_name = name.."-small-beam"
local sticker_name = name.."-sticker"
...
small_beam.name = small_beam_name
