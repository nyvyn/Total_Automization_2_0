-- Switch to using prototypes directory conventions for 2.0
local path = util.path("prototypes/units/rocket_guy/")
...
{
  filename = util.path("prototypes/units/rocket_guy/rocket_guy_rocket.png"),
  frame_count = 13,
  line_length = 1,
  width = 32,
  height = 62,
