local path = util.path("prototypes/units/plasma_bot/")
...
local projectile_name = name.."-projectile"
local small_projectile_name = name.."-small-projectile"
local trail_smoke_name = name.."-smoke"
local big_smoke_name = name.."-big-smoke"
local splash_name = name.."-splash"
local small_splash_name = name.."-small-splash"
local bot =
{
  type = "unit",
  name = name,
  ...
  {
    type = "projectile",
    ammo_category = util.ammo_category("circuit-units"),
      ...
      {
        {
          ...
          particle_name = small_projectile_name,
...
small_projectile.name = small_projectile_name
